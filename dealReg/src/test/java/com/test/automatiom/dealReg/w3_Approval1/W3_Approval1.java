...
public class W3_Approval1 extends TestBase {
	...
	public void Approve_Form() throws Exception {
		try {
			...
			WebDriverWait wait = new WebDriverWait(driver, 30);
			{
				...
				driverwait(30);
				 		driver.findElement(By.id("com_ibm_ciolab_dr_admin_TasksListFilter_0_solutionIdFilter")).sendKeys("P329023");
				...
				Thread.sleep(10000);
				 		driver.findElement(By.id("com_ibm_ciolab_dr_mytasks_ListFilter_0_request_Id")).sendKeys("S329126");
				 		Thread.sleep(7000);
				 		...
				 		Thread.sleep(10000);
				 		 driver.findElement(By.xpath("//td[contains(text(),'Claim')]")).click();
				 		 driver.findElement(By.xpath("//span[contains(text(),'Submit')]/../span[3]")).click();
				 		Thread.sleep(9000);
				 		System.out.println("Right Clicking on record");
				 		action1.contextClick(driver.findElement(By.xpath("//td[contains(text(),'Initial Review')]"))).build().perform();
				 		Thread.sleep(10000);
				 		System.out.println("Clicking on review");
